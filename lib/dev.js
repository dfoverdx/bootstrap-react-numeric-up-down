...
var _stylesheetRegistry2 = _interopRequireDefault(stylesheetRegistry);
...
function convert(createElement, element) {
  ...
  return createElement.apply(undefined, [element.tag, _extends$2({}, mixins.attrs, remaining)].concat(toConsumableArray$1(children)));
}
...
var iconDefinitionPropType = propTypes.oneOfType([propTypes.string, propTypes.element, propTypes.shape({
...
/*#__PURE__*/
function (_Component) {
  _inherits(NumericUpDown, _Component);
  ...
  function NumericUpDown(props) {
    ...
    _this.state = {
      value: _this.props.value || _this.props.min || 0,
      targetValue: null
    };
  ...
  _createClass(NumericUpDown, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          inputColor = _this$props.inputColor,
          className = _this$props.className,
          minusIcon = _this$props.minusIcon,
          plusIcon = _this$props.plusIcon,
          disabled = _this$props.disabled,
          step = _this$props.step,
          props = _objectWithoutProperties(_this$props, ["min", "max", "onChange", "iconColor", "inputColor", "className", "minusIcon", "plusIcon", "disabled", "step"]),
          value = this.state.value,
          iconStyles = getIconStyles(),
          iconClasses = [iconStyles.className, iconColor && "text-".concat(iconColor)];

      if (React__default.isValidElement(minusIcon)) {
        var _props = {
          className: classnames.apply(void 0, [minusIcon.props.className, 'minus-icon', value <= min && 'disabled'].concat(iconClasses))
        };
        minusIcon = React__default.cloneElement(minusIcon, _props);
      } else {
        minusIcon = React__default.createElement(FontAwesomeIcon, {
          icon: minusIcon,
          onClick: this._decrementValue,
          className: classnames.apply(void 0, ['minus-icon', value <= min && 'disabled'].concat(iconClasses))
        });
      }

      if (React__default.isValidElement(plusIcon)) {
        var _props2 = {
          className: classnames.apply(void 0, [plusIcon.props.className, 'plus-icon', value >= max && 'disabled'].concat(iconClasses))
        };
        plusIcon = React__default.cloneElement(plusIcon, _props2);
      } else {
        plusIcon = React__default.createElement(FontAwesomeIcon, {
          icon: minusIcon,
          onClick: this._incrementValue,
          className: classnames.apply(void 0, ['plus-icon', value >= max && 'disabled'].concat(iconClasses))
        });
      }

      return React__default.createElement("div", _extends({}, props, {
        className: style$2.dynamic([["2012225385", [this.props.inputAlign]]]) + " " + (props.className != null && props.className || classnames(className, 'numeric-up-down', disabled && 'disabled') || "")
      }), minusIcon, React__default.createElement("input", {
        type: "number",
        min: min,
        max: max,
        step: step,
        ...
        className: style$2.dynamic([["2012225385", [this.props.inputAlign]]]) + " " + (classnames('form-control mx-2', inputColor && "text-".concat(inputColor)) || "")
      }), plusIcon, iconStyles.styles, React__default.createElement(style$2, {
        styleId: "2012225385",
        css: ".numeric-up-down.__jsx-style-dynamic-selector{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex-direction:row;-ms-flex-direction:row;flex-direction:row;-webkit-flex-wrap:nowrap !important;-ms-flex-wrap:nowrap !important;flex-wrap:nowrap !important;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;}input.__jsx-style-dynamic-selector{text-align:".concat(this.props.inputAlign, ";-webkit-flex:1;-ms-flex:1;flex:1;-moz-appearance:textfield;}input.__jsx-style-dynamic-selector::-webkit-outer-spin-button,input.__jsx-style-dynamic-selector::-webkit-inner-spin-button{-webkit-appearance:none;margin:0;}"),
...
_defineProperty(NumericUpDown, "defaultPropTypes", {
