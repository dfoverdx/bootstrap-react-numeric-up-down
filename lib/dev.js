...
var FontAwesomeIcon = reactFontAwesome && reactFontAwesome.FontAwesomeIcon,
  ...
  _createClass(NumericUpDown, [{
    ...
    value: function render() {
      var _this$props2 = this.props,
          ...
          inputProps = _objectWithoutProperties(_this$props2, ["iconColor", "inputColor", "className", "minusIcon", "plusIcon", "inputAlign", "allowManualInputWithNaNBounds"]),
          ...
          iconClasses = [iconClass, iconColor && "text-".concat(iconColor)],
      ...
      var minusIconClasses = ['minus-icon', (value <= min || disabled) && 'disabled'].concat(iconClasses),
          plusIconClasses = ['plus-icon', (value >= max || disabled) && 'disabled'].concat(iconClasses);

      if (React__default.isValidElement(minusIcon)) {
        var props = {
          className: classnames.apply(void 0, [minusIcon.props.className].concat(_toConsumableArray(minusIconClasses)))
        };
        minusIcon = React__default.cloneElement(minusIcon, props);
      } else if (mightBeFAIcon(minusIcon)) {
        try {
          var tmp = React__default.createElement(FontAwesomeIcon, {
            icon: minusIcon,
      ...
      if (minusIcon.constructor === String) {
        minusIcon = React__default.createElement("span", {
          className: classnames(minusIconClasses)
        }, minusIcon);
      }
      ...
      if (React__default.isValidElement(plusIcon)) {
        var _props = {
          className: classnames.apply(void 0, [plusIcon.props.className].concat(_toConsumableArray(plusIconClasses)))
        };
        plusIcon = React__default.cloneElement(plusIcon, _props);
      } else if (mightBeFAIcon(plusIcon)) {
        try {
          var _tmp = React__default.createElement(FontAwesomeIcon, {
            icon: plusIcon,
      ...
      if (plusIcon.constructor === String) {
        plusIcon = React__default.createElement("span", {
          className: classnames(plusIconClasses)
        }, plusIcon);
      }

      return React__default.createElement("div", _extends({}, inputProps, {
        className: _JSXStyle.dynamic([["2780546048", [this.props.inputAlign]]]) + " " + (inputProps.className != null && inputProps.className || classnames(divClasses) || "")
