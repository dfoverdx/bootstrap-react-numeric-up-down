  ...
  _createClass(NumericUpDown, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          inputAlign = _this$props.inputAlign,
          props = _objectWithoutProperties(_this$props, ["min", "max", "onChange", "iconColor", "inputColor", "className", "minusIcon", "plusIcon", "disabled", "step", "inputAlign"]),
          value = this.state.value,
      ...
      return React__default.createElement("div", _extends({}, props, {
        className: _JSXStyle.dynamic([["2780546048", [this.props.inputAlign]]]) + " " + (props.className != null && props.className || classnames(divClasses) || "")
        ...
        className: _JSXStyle.dynamic([["2780546048", [this.props.inputAlign]]]) + " " + (classnames('form-control mx-2', inputColor && "text-".concat(inputColor)) || "")
      }), plusIcon, iconStyles.styles, React__default.createElement(_JSXStyle, {
        styleId: "2780546048",
...
function getIconStyles() {
  return {
    styles: React__default.createElement(_JSXStyle, {
      styleId: "3140308683",
      css: ".minus-icon.jsx-3140308683,.plus-icon.jsx-3140308683{cursor:pointer;}.minus-icon.disabled.jsx-3140308683,.plus-icon.disabled.jsx-3140308683,.disabled.jsx-3140308683 .minus-icon.jsx-3140308683,.disabled.jsx-3140308683 .plus-icon.jsx-3140308683{opacity:.65;cursor:inherit;}"
    }),
    className: "jsx-3140308683"
  };
}
